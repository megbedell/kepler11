...
ax1.text(6247.55,0.6,'Fe II',ha='center',size=22)
ax1.text(6246.3,0.35,'Fe I',ha='center',size=22)
ax1.text(6245.6,0.67,'Sc II',ha='center',size=22)
ax1.text(6244.45,0.65,'Si I',ha='center',size=22)

ax1.set_xlim([6244.0,6248.0])
ax1.set_ylim([0.31,1.05])
ax1.set_ylabel(r'Normalized Flux',size=20)
...
ax2.set_ylabel(r'Diff.',size=20)
ax2.set_xlabel(r'Wavelength ($\AA$)',size=20)
